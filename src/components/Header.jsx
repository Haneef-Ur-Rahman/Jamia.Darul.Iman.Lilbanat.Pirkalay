...
//                   <span className="text-brand-maroon font-bold text-xs urdu-text">جامعۃ دارالإیمان</span>
...
//               <div className="flex-1 flex flex-col py-4 px-4 gap-0 urdu-text overflow-y-auto">
//                 {navLinks.map((link, i) => (
//                   <a
//                     key={i}
//                     href={link.href}
...
//                     onClick={() => {
//                       setIsMenuOpen(false)
//                       if (!link.href.startsWith('http')) setActiveIndex(i)
//                     }}
//                     className={`text-base font-bold py-2 px-3 rounded-xl transition-all duration-200 ${activeIndex === i && !link.href.startsWith('http')
//                       ? 'text-brand-maroon bg-brand-gold/10'
//                       : 'text-on-surface-variant/80 hover:text-brand-maroon hover:bg-surface-container-low'
//                       }`}
//                   >
//                     {link.label}
//                   </a>
...
//                   }}
//                   className="w-full bg-brand-maroon text-white py-2.5 rounded-xl font-bold text-xs tracking-[0.15em] shadow-lg active:scale-95 transition-transform"
//                 >
//                   DONATE NOW
//                 </button>
//               </div>
